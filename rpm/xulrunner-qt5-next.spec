...
echo "export PATH=/home/mersdk/.cargo/bin:\/home/mersdk/.cargo/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin" >> "%BUILD_DIR"/rpm-shared.env
echo "export RUSTC=/home/mersdk/.cargo/bin/rustc" >> "%BUILD_DIR"/rpm-shared.env
echo "export CARGO=/home/mersdk/.cargo/bin/cargo" >> "%BUILD_DIR"/rpm-shared.env
